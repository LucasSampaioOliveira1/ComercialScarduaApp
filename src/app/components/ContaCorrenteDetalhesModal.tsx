...
export default function ContaCorrenteDetalhesModal({ conta, onClose, onEdit, canEdit }: ContaCorrenteDetalhesModalProps) {
  ...
  // Modificar para abrir modal em vez de gerar direto
  const handleGerarTermoClick = () => {
    setShowConfirmModal(true);
  };
  
  // Função para gerar PDF após confirmação
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        ...
        >
          ...
          <div className="p-6">
            ...
            {/* Botões de ação - alterando para abrir modal em vez de gerar direto */}
            <div className="flex justify-end space-x-3 pt-3 border-t border-gray-200">
              ...
              <button
                onClick={handleGerarTermoClick}
                className="px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors flex items-center font-medium"
              >
